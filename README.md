...
## Loss Function:
We employ localization loss functions to train the model. The localization loss ensures accurate bounding box predictions 

## Training:
The model is trained on the dataset using TensorFlow's optimization techniques, such as stochastic gradient descent (SGD) or Adam optimizer. We analyze the convergence and performance metrics to evaluate the model's learning behaviour
